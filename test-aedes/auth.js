...
test('authenticate successfully a client with username and password', function (t) {
  ...
  s.broker._authenticate = function (client, username, password, cb) {
...
test('authorize publish', function (t) {
  ...
  s.broker._authorizePublish = function (client, packet, cb) {
...
test('authorize subscribe', function (t) {
  ...
  s.broker._authorizeSubscribe = function (client, sub, cb) {
    t.ok(client, 'client exists')
    t.same(sub, {
      topic: 'hello',
      qos: 0
...
test('negate subscription with correct persistence', function (t) {
  ...
  broker._authorizeSubscribe = function (client, sub, cb) {
    t.ok(client, 'client exists')
    if (sub.topic === 'hello') {
      sub = null
    }
...
test('failed authentication does not disconnect other client with same clientId', function (t) {
  ...
  broker._authenticate = function (client, username, password, cb) {
